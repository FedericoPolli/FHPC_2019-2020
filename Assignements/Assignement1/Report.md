...
- Compute Theoretical Peak performance for your laptop/desktop
  - Identify the CPU: Intel(R) Core(TM) i7-7500U
  
  - Identify the frequency: 2.70 GHz
  
  - Identify how many cores: 2 

  - Identify the number of floating point for cycle: 16 (Intel Kaby Lake architecture, https://en.wikipedia.org/wiki/FLOPS) 
...
- Compute sustained Peak performance for your  cell-phone
  ...
  -Identify the CPU and calculate the Peak performance of the CPU: Qualcomm Snapdragon 625, Octa core, 2 GHz, 2 Flops per cycle.
...
- Find out in which year  your cell phone/laptop  could have been in top1% of Top500 
  ...
  | ---------- | ----------------------- | ----------- | --------------- | ------------------------------------------- | --------------------------------- |
  | SmartPhone | Qualcomm Snapdragon 625 | 1209 MFLOPS |  Until 11/1994  |       Until 1985 (Cray-2 1.9 GFLOPS)        |            4 (Cray 2)             |
  | Laptop     |        i7-7500U         | 86.4 GFLOPS |  Until 11/2001  | Until 11/1993 (Numerical Wind Tunnel Japan) | 140 (Numerical Wind Tunnel Japan) |
