...
N=1000000;
    for p=1:np
        Time_1(p)=T_comp*(p-1+N/p)+T_read+2*(p-1)*T_comm;
...
N=10000000;
    for p=1:np
        Time_2(p)=T_comp*(p-1+N/p)+T_read+2*(p-1)*T_comm;
...
N=100000000;
    for p=1:np
        Time_3(p)=T_comp*(p-1+N/p)+T_read+2*(p-1)*T_comm;
...
N=1000000000;
    for p=1:np
        Time_4(p)=T_comp*(p-1+N/p)+T_read+2*(p-1)*T_comm;
